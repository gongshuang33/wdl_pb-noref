...
task NGScorrectTask {
	...
	command <<<
		...
		/export/personal/pengh/Software/LoRDEC-0.5.3-Linux/bin/lordec-correct -2 ~{sep=', ' fq_lists} -a 100000 -k 19 -s 3 -m 8000MB -T 10 -o NGS_corrected.fasta -i ~{all_polished_fa}
